            ...
            public void actionPerformed(ActionEvent e) {
                if (file != null && file.getName().contains(".wav")) {
                    ...
                    try {
                        ...
                        URL url2 = new URL("https://wavelets.radovandesign.com/compress/?name=" + file.getName());
                        URLConnection c2 = url2.openConnection();
                        c2.setDoOutput(true);
                        InputStream response2 = c2.getInputStream();
